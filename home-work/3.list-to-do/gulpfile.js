 ...
 */
function watch_task() {
  watch('src/sass/**/*.sass', sass_task,browserSync.reload);
  watch('src/img/**/*', image_task,browserSync.reload);

  // Delete this if you don't use the pug_task or copy_task from the docs.
  watch('src/pug/**/**/*.pug', pug_task,browserSync.reload);
  watch('src/js/**/*.js', copy_task, browserSync.reload);
  watch('src/css/**/*.css', copy_task, browserSync.reload);
};
